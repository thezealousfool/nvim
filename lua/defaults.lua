...
local options = {
  ...
  foldcolumn = "1", -- Do not show folds in the gutter
  foldlevel = 99, -- Maximum fold level
  foldlevelstart = -1, -- Initial folding level
  foldenable = true, -- Enable folding
  fillchars = [[eob: ,fold: ,foldopen:,foldsep: ,foldclose:]], -- characters used for folding
  ...
  colorcolumn = "81", -- highlight the 80th column
}
